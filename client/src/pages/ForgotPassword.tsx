      ...
      <div className="min-h-screen flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-semibold tracking-tight mb-2">Email Enviado</h1>
            <p className="text-muted-foreground">Verifique sua caixa de entrada</p>
          </div>

          <div className="mb-6 p-6 rounded-2xl bg-accent/5 border border-accent/20">
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight mb-2">Esqueceu a Senha?</h1>
          <p className="text-muted-foreground">Sem problema, vamos te ajudar a recuperá-la</p>
        </div>
